...
def calcular_score_plan(plan_generado, plan_optimo):
    # La metrica premia longitud exacta (2 pts), prefijo correcto en orden
    # (hasta 3 pts) y coincidencia total exacta (5 pts). No valida planes
    # equivalentes con acciones en otro orden.
